...
-- code instead utilizing the VIEW written below
SELECT *
...
--- Same as below, but using a view "instrument_per_month", written in bullet 1
...
--- using view lessons_per_month, defined directly below
SELECT *
...
--- utilizes view lessons_per_month, defined in bullet 3
SELECT lesson, SUM(sum)/12 as average
FROM lessons_per_month
GROUP BY lesson
ORDER BY average DESC
---

---- this code is deprecated, use the view-utilizing code above
